...
namespace LifeFall
{
    public class ChaseCamera : GameComponent, ICamera
    {
        ...
        public ChaseCamera(Game game, GameObject chasedObject)
            : base(game)
        {
            this.ChasedObject = chasedObject;
        }

        public GameObject ChasedObject { get; set; }
        ...
        private float stiffness = 2500.0f;
        ...
        public void UpdateChasedObject()
        {
            this.ChasePosition = ChasedObject.Position;
            this.ChaseDirection = ChasedObject.Forward;
            this.Up = ChasedObject.UpVector;

        }
        public override void Initialize()
        {
            this.DesiredPositionOffset = new Vector3(0.0f, 0.25f, 25.0f);
            this.LookAtOffset = new Vector3(0.0f, 0.16f, 10.0f);
